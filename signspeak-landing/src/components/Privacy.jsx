...
const MeshModel = lazy(() => import('./MeshModel.jsx'))
      ...
      <div className="relative mx-auto w-full max-w-[1400px]">
        <div className="grid grid-cols-1 lg:grid-cols-12 lg:gap-10">
          ...
          <div className="lg:col-span-4">
            <div className="priv-fade relative hidden h-[440px] lg:block xl:h-[520px]">
              <div
                aria-hidden="true"
              ...
              <p className="absolute bottom-0 left-0 font-mono-tech text-[10px] uppercase tracking-[0.3em] text-neutral-600">
                Live mesh — moves with your cursor
              </p>
            </div>
          </div>
        </div>
